...
def telegram_webhook():
    ...
    if "callback_query" in update:
        ...
        try:
            ...
            log.error("Callback ACK error:", e)
        ...
        texts = {
            ...
            "fa": (
                ...
                "• طرح های بدون محدودیت زمانی مخصوص نت ملی ایران\n"
        ...
        try:
            ...
            log.error("Callback send wellcom error:", e)
...
# ── Normal messages (/start etc.) ─────────────────────
    ...
    if text.startswith("/start"):
        ...
        try:
            ...
            log.error("Callback send lang button error:", e)

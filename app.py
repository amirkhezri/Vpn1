...
def telegram_webhook():
    ...
    if "callback_query" in update:
        ...
        texts = {
            "en": (
                "🚀 Fast & Secure VPN\n\n"
                "• Unlimited & Volume Plans\n"
                "• Telegram Stars & Crypto Payments\n"
                "• Instant VLESS Delivery\n"
                "• Optimized for Iran National Network\n\n"
            ...
            "fa": (
                "🚀 وی پی ان سریع و امن\n\n"
                "• پلن نامحدود و حجمی\n"
                "• پرداخت با استارز و کریپتو\n"
                "• تحویل فوری VLESS\n"
                "• بهینه شده برای نت ملی ایران\n\n"
                "برای ورود روی دکمه زیر بزنید."
            ),

            "ru": (
                "🚀 Быстрый и безопасный VPN\n\n"
                "• Безлимитные и объёмные тарифы\n"
                "• Оплата Stars и криптой\n"
                "• Мгновенная выдача VLESS\n"
                "• Оптимизировано для Ирана\n\n"

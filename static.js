...
const TARIFFS = [
    ...
    //volume tariffs
    {
        ...
        badge: null,
        discountPct: 0,
        features: ['بدون محدودیت زمانی', 'فقط مخصوص نت ملی ایران', 'پروتکل VLESS', 'پشتیبانی 24/7']
    },
    {
        id: 'volume_3',
        type: 'volume',
        ...
        badge: 'save',        // Popular
        discountPct: 10,
        features: ['بدون محدودیت زمانی', 'فقط مخصوص نت ملی ایران', 'پروتکل VLESS', 'پشتیبانی 24/7', '10% تخفیف']
    },
    {
        id: 'volume_5',
        type: 'volume',
        ...
        badge: null,
        discountPct: 20,
        features: ['بدون محدودیت زمانی', 'فقط مخصوص نت ملی ایران', 'پروتکل VLESS', 'پشتیبانی 24/7', '20% تخفیف']
    },
    {
        id: 'volume_10',
        type: 'volume',
        ...
        badge: 'best',        // Best price
        discountPct: 33,
        features: ['بدون محدودیت زمانی', 'فقط مخصوص نت ملی ایران', 'پروتکل VLESS', 'پشتیبانی 24/7', 'پشتیبانی ویژه', '33% تخفیف']
    }

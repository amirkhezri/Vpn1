...
const TARIFFS = [
    ...
    //volume tariffs
    {
        ...
        badge: null,
        discountPct: 0,
        features: ['Без ограничений по времени', 'Только для национального интернета Ирана', 'VLESS протокол', 'Поддержка 24/7']
    },
    {
        id: 'volume_3',
        type: 'volume',
        ...
        badge: 'save',        // Popular
        discountPct: 10,
        features: ['Без ограничений по времени', 'Только для национального интернета Ирана', 'VLESS протокол', 'Поддержка 24/7', '10% скидка']
    },
    {
        id: 'volume_5',
        type: 'volume',
        ...
        badge: null,
        discountPct: 20,
        features: ['Без ограничений по времени', 'Только для национального интернета Ирана', 'VLESS протокол', 'Поддержка 24/7', '20% скидка']
    },
    {
        id: 'volume_10',
        type: 'volume',
        ...
        badge: 'best',        // Best price
        discountPct: 33,
        features: ['Без ограничений по времени', 'Только для национального интернета Ирана', 'VLESS протокол', 'Поддержка 24/7', 'Приоритетная поддержка', '33% скидка']
    }
